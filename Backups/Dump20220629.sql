...
INSERT INTO `cursos` VALUES (1,'HTML 5','Curso de HTML5',40,37,2014),(2,'Algoritmo','Logica de Programação',20,15,2014),(3,'Photoshop','Dicas de Photoshop CC',10,8,2014),(4,'PHP','Curso de PHP para iniciantes',40,20,2015),(5,'Java','Introdução a Linguagem Java',40,29,2015),(6,'MySQL','Banco de dados MySQL',30,15,2016),(7,'Word','Curso completo de word',40,30,2016);
